...
type DeleteUsersIdJSONRequestBody = Users
...
type DeleteUsersId201JSONResponse Users

func (response DeleteUsersId201JSONResponse) VisitDeleteUsersIdResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(201)
...
type PatchUsersId201JSONResponse Users
