...
// DeleteMessagesIdJSONRequestBody defines body for DeleteMessagesId for application/json ContentType.
type DeleteMessagesIdJSONRequestBody = Message
...
type DeleteMessagesIdRequestObject struct {
	Id   int `json:"id"`
	Body *DeleteMessagesIdJSONRequestBody
}
...
type DeleteMessagesId201JSONResponse Message

func (response DeleteMessagesId201JSONResponse) VisitDeleteMessagesIdResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(201)
...
type PatchMessagesId201JSONResponse Message

func (response PatchMessagesId201JSONResponse) VisitPatchMessagesIdResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(201)
...
func (sh *strictHandler) DeleteMessagesId(ctx echo.Context, id int) error {
	...
	var body DeleteMessagesIdJSONRequestBody
	if err := ctx.Bind(&body); err != nil {
		return err
	}
	request.Body = &body
